            ...
            elseif strcmp(cfg.shuffle, 'yes')
                ...
                switch cfg.surrogatetype
                    ...
                    case 'blockreverse1'
                        trial2 = t4t;
                        cutpoint = round( (timeindices(2)-timeindices(1)+1) * rand(1));
                        timespan =flip([cutpoint:timeindices(2),timeindices(1):cutpoint-1],2);
                        
                    case 'blockreverse2'
                        trial2 = t4t;
                        cutpoint = round( (timeindices(2)-timeindices(1)+1) * rand(1));
                        timespan =[flip(cutpoint:timeindices(2),2),timeindices(1):cutpoint-1];
                        
                    case 'blockreverse3'
                        trial2 = t4t;
                        cutpoint = round( (timeindices(2)-timeindices(1)+1) * rand(1));
                        timespan =[cutpoint:timeindices(2),flip(timeindices(1):cutpoint-1,2)];
                    case 'swapneighbors'
                        if mod(t4t,2)==0
                            trial2 = t4t-1;
                        else
